                      ...
                      {!confirmedRoles.has(role.id) ? (
                        <>
                          ...
                          <button
                            ...
                            className="px-6 py-2.5 bg-primary text-white rounded-xl font-semibold hover:bg-primary-dark active:bg-white active:text-primary active:border active:border-primary transition-colors flex items-center gap-2 shadow-md"
                          >
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700 rounded-xl border border-green-200">
                          ...
                          <button
                            onClick={() => handleConfirm(role)}
                            className="ml-2 px-4 py-2 bg-primary text-white rounded-xl text-sm font-semibold hover:bg-primary-dark active:bg-white active:text-primary active:border active:border-primary transition-colors flex items-center gap-2 shadow-md"
                          >
                            Open Intake
